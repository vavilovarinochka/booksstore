...
const Privacy = () =>{
    return(
        <Container>
            <h1 style={{color: 'rgba(0,0,0,.55)'}}>Политика конфиденциальности</h1>
            <br/><h2 style={{color: 'rgba(0,0,0,.55)'}}>1. Общие положения</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>2. Основные понятия, используемые в Политике</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>3. Основные права и обязанности Оператора</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>4. Основные права и обязанности субъектов персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>5. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>6. Принципы обработки персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>7. Цели обработки персональных данных</h2>
            <p>
                ...
                <br/>– предоставление доступа Пользователю к сервисам, информации и/или материалам, содержащимся на веб-сайте httpsː//thismywebsite·com.
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>8. Правовые основания обработки персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>9. Условия обработки персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>10. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>11. Перечень действий, производимых Оператором с полученными персональными данными</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>12. Трансграничная передача персональных данных</h2>
            <p>
            ...
            <h2 style={{color: 'rgba(0,0,0,.55)'}}>13. Конфиденциальность персональных данных</h2>
            <p>
                Оператор и иные лица, получившие доступ к персональным данным, обязаны не раскрывать третьим лицам и не распространять персональные данные без согласия субъекта персональных данных, если иное не предусмотрено федеральным законом.
            </p>
            <br/>

            <h2 style={{color: 'rgba(0,0,0,.55)'}}>14. Заключительные положения</h2>
            <p>
